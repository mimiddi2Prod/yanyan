    ...
    this.Service = async function (version, param, callback) {
        ...
        try {
            ...
            if (param['state'] == -1) {
                ...
                sql = "select user_id,item_id,image,`number`,update_time,create_time,state,address_text,tel,receiver,single_price,postage,id,tradeId,after_sale_state,select_card_id,discount_price from `order` where tradeId in (?) ORDER BY update_time desc";
                console.info(sql)
